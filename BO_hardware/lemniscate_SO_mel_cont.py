...
if __name__ == "__main__":
    ...
    for cf in allcfs.crazyflies:
        cf.setParam("ctrlMel/kp_xy", 0.2) #0.4
        cf.setParam("ctrlMel/ki_xy", 0.05) #0.05
        cf.setParam("ctrlMel/kp_z", 1.00) #1.25
    ...
    #### Init save files #################################
    dir="/home/franka_panda/Holz_drones/Mel_ls{}_{}_beta_{}_{}_noise0.1_badstrt_64".format(ls_p, ls_i,beta_type,total_rounds)  
