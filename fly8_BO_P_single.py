...
if __name__ == "__main__":
    ...
    for i in range(0, int(ARGS.duration_sec*env.SIM_FREQ), AGGR_PHY_STEPS):
        ...
        if i%CTRL_EVERY_N_STEPS == 0:
            ...
            if(((i+CTRL_EVERY_N_STEPS)%ROUND_STEPS) == 0):
                ...
                PID_coeff[0]=np.reshape(np.array(candidate.squeeze()),PID_coeff[0].shape)
    ...
    FILENAME="pid_BO"+"_R_"+R_MATRIX+"_alpha_"+AQUISITION_F+"_start_P_"+PID_START+"_rounds_"+NR_ROUNDS
