...
class DSLPIDControl(BaseControl):
    ...
    ################################################################################
    #****Added
    def setPWM2RPM_scale_hw(self, newscale):
        self.PWM2RPM_SCALE_hw=newscale
    ...
    def _dslPIDPositionControl(self,
        ...
        vel_e = target_vel - cur_vel  ###(self.last_pos_e - pos_e)/control_timestep 
    ...
    def _dslPIDAttitudeControl(self,
        ...
        return self.PWM2RPM_SCALE_hw * pwm + self.PWM2RPM_CONST
