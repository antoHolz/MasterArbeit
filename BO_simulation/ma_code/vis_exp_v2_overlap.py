...
csvdir='C:/Users/Usuario/Documents/Masterarbeit/code/gym-pybullet-drones-1.0.0/files/csvs/Experiments_v3/traj_3/'
dirnames=['SO_100_const_xy', 'SO_100_const_xz']#['baseline', 'ET_10', 'SO_10']
...
legend_GP[::2]=['xy','xz']#['baseline','SafeOpt\u221E','TVSafeOpt10', 'TVSO\u221E']
...
plt.savefig(csvdir+'figures/TVSO\u221E_bog.png')
plt.show()
