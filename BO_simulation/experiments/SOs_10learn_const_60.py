...
if __name__ == "__main__":
    for g in range(100):
        ...
        parser.add_argument('--duration_sec',       default=720,         type=int,           help='Duration of the simulation in seconds (default: 5)', metavar='')
            ...
            if i%CTRL_EVERY_N_STEPS == 0:
                ...
                if(i==0 or ((i%ROUND_STEPS) == TRAJ_STEPS)):
                    ...
                    #         learn_at=learn_at.append({'timestep':round_nr+1}, ignore_index=True)
                            ...
                            #  'E_t':((np.sqrt(rho_t)*np.sqrt(var_t)+omega_t).squeeze())},ignore_index=True)
        ...
        FILENAME="SOs_10learn_const/SOs_10learn_const"+"_rounds_"+NR_ROUNDS
